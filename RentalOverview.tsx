...
import { Users, AlertCircle, CheckCircle, Plus, Clock, Bell } from 'lucide-react';
...
export const RentalOverview: React.FC = () => {
  ...
  const stats = [
    { label: 'Total Properties', value: '5', icon: Users, color: 'blue' },
    { label: 'Active Tenants', value: '4', icon: CheckCircle, color: 'green' },
    { label: 'Pending Issues', value: '2', icon: AlertCircle, color: 'yellow' },
    { label: 'On-time Payments', value: '95%', icon: Clock, color: 'purple' }
  ];
